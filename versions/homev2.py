"""
This version I changed the name of the RegistrationWindow class from root to something else. 
This change helped me meatch the Pylint formatting standard. 
"""
...
def login_verify():
    ...
    if " " in name_value:
        reminder_label = Label(login_frame,
